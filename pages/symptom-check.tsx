...
const severityConfig = {
  LOW:      { label: 'Low Risk — Monitor at home',      headerBg: 'bg-emerald-600', badgeBg: 'bg-emerald-100 text-emerald-700' },
  MEDIUM:   { label: 'Moderate — See a doctor soon',    headerBg: 'bg-amber-500',   badgeBg: 'bg-amber-100 text-amber-700' },
  HIGH:     { label: 'High Risk — Seek urgent care',    headerBg: 'bg-orange-600',  badgeBg: 'bg-orange-100 text-orange-700' },
  CRITICAL: { label: 'Critical — Go to emergency now',  headerBg: 'bg-red-600',     badgeBg: 'bg-red-100 text-red-700' },
}
              ...
              <div className="rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
                <div className="bg-slate-800 px-5 py-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-bold text-sm">Doctor Visit Note</p>
                      <p className="text-slate-400 text-xs">Ready to share via WhatsApp or print</p>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl border border-slate-100 p-5 font-mono text-xs text-slate-700 leading-relaxed space-y-3">
                    ...
                    <div className="border-t border-dashed border-slate-200 pt-3 space-y-2.5">
                      ...
                      {conditions.filter(c => c.probability > 0).length > 0 && (
                        <div>
                          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">AI Suggested Diagnosis</p>
                      ...
                      {medicines.filter(m => m.type !== 'ADVICE').length > 0 && (
                        <div>
                          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Suggested Medications</p>
                      ...
                      {redFlags.length > 0 && (
                        <div>
                          <p className="text-[10px] font-bold text-red-400 uppercase tracking-widest mb-1">⚠ Seek Care Immediately If</p>
                    ...
                    <p className="text-[10px] text-slate-400 border-t border-dashed border-slate-200 pt-2">
                      Generated by HealthAI · For reference only — not a medical prescription
                    </p>
                  </div>

                  <p className="text-xs text-slate-400 text-center mt-3 flex items-center justify-center gap-1.5">
                    <span className="text-emerald-500">✓</span>
                    Tap <strong>Copy</strong> above to share on WhatsApp with your doctor
                  </p>
                </div>
              </div>
            )}
            ...
            {assessment && (
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-bold text-sm">View Your Health Patterns</p>
                    <p className="text-white/70 text-xs mt-0.5">AI analysis of your symptom history — discover recurring triggers</p>
                  </div>
                </div>
